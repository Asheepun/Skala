:level 15 20 {
	...
	World_addObstacle(w, getVec2f(0, 160), getVec2f(WIDTH, 20), NONE);

	//World_addObstacle(w, getVec2f(50, 50), getVec2f(20, 20), ALL_SWITCH_X_Y);

	World_addDoorKey(w, getVec2f(100, 100), ALL);

	World_addDoor(w, getVec2f(200, 100), getVec2f(20, 60), NONE);
