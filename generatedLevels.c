...
void World_generateLevel14(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(360, -BIG_BLOCKING_SIZE), getVec2f(100, BIG_BLOCKING_SIZE + 20), NONE);
...
void World_generateLevel15(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(300, 100), getVec2f(BIG_BLOCKING_SIZE, HEIGHT - 160), NONE);
...
void World_generateLevel16(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(0, 0), getVec2f(BIG_BLOCKING_SIZE, 10), NONE);

	World_addObstacle(world_p, getVec2f(300, 40), getVec2f(BIG_BLOCKING_SIZE, HEIGHT - 110), NONE);
...
void World_generateLevel17(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(WIDTH - 80, 40), getVec2f(BIG_BLOCKING_SIZE, 80), NONE);
...
void World_generateLevel23(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(0, 210), getVec2f(BIG_BLOCKING_SIZE, 60), NONE);
...
void World_generateLevel24(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(300, -BIG_BLOCKING_SIZE), getVec2f(20, BIG_BLOCKING_SIZE + 150), NONE);
...
void World_generateLevel26(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(0, 210), getVec2f(BIG_BLOCKING_SIZE, BIG_BLOCKING_SIZE), NONE);
	...
	World_addObstacle(world_p, getVec2f(0, -BIG_BLOCKING_SIZE), getVec2f(110, BIG_BLOCKING_SIZE + 10), NONE);
...
void World_generateLevel28(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(300, -BIG_BLOCKING_SIZE), getVec2f(20, BIG_BLOCKING_SIZE + 60), NONE);
...
void World_generateLevel39(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(380, 60), getVec2f(BIG_BLOCKING_SIZE, HEIGHT - 120), NONE);
...
void World_generateLevel42(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(WIDTH - 20, 0), getVec2f(BIG_BLOCKING_SIZE, HEIGHT), NONE);
...
void World_generateLevel46(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(WIDTH - 150, 70), getVec2f(BIG_BLOCKING_SIZE, HEIGHT - 130), NONE);

	World_addObstacle(world_p, getVec2f(WIDTH - 100, -BIG_BLOCKING_SIZE), getVec2f(BIG_BLOCKING_SIZE, BIG_BLOCKING_SIZE + 40), NONE);
...
void World_generateLevel48(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(WIDTH - 50, 190), getVec2f(BIG_BLOCKING_SIZE, 80), NONE);
...
void World_generateLevel49(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(WIDTH - 20, 0), getVec2f(BIG_BLOCKING_SIZE, HEIGHT - 105), NONE);
...
void World_generateLevel53(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(WIDTH - 150, 90), getVec2f(BIG_BLOCKING_SIZE, 120), NONE);

	World_addObstacle(world_p, getVec2f(0, -BIG_BLOCKING_SIZE), getVec2f(20, BIG_BLOCKING_SIZE + HEIGHT), NONE);
...
void World_generateLevel55(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(WIDTH - 40, 190), getVec2f(BIG_BLOCKING_SIZE, 100), NONE);
...
void World_generateLevel61(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(WIDTH - 200, 130), getVec2f(BIG_BLOCKING_SIZE, 80), NONE);
...
void World_generateLevel63(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(WIDTH - 270, -BIG_BLOCKING_SIZE), getVec2f(40, BIG_BLOCKING_SIZE + 170), NONE);
...
void World_generateLevel65(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(200, -BIG_BLOCKING_SIZE), getVec2f(40, BIG_BLOCKING_SIZE + 60), NONE);
...
void World_generateLevel66(World *world_p){
	...
	World_addScaleField(world_p, getVec2f(200, 40), getVec2f(60, 60), NONE);
...
void World_generateLevel71(World *world_p){
	...
	World_addDoorKey(world_p, getVec2f(200, 170), NONE);
...
void World_generateLevel72(World *world_p){
	...
	World_addDoorKey(world_p, getVec2f(200, 170), NONE);
	//World_addDoorKey(world_p, getVec2f(150, 30), ALL);

	World_addObstacle(world_p, getVec2f(0, 210), getVec2f(WIDTH, 60), NONE);

	World_addObstacle(world_p, getVec2f(0, 130), getVec2f(80, 20), NONE);

	//World_addObstacle(world_p, getVec2f(200, 100), getVec2f(40, 40), NONE);

	World_addDoor(world_p, getVec2f(60, 150), getVec2f(20, 60), NONE);

	World_addScaleField(world_p, getVec2f(250, 130), getVec2f(80, 80), ALL);

	World_addScaleField(world_p, getVec2f(80, 130), getVec2f(20, 80), NONE);
...
void World_generateLevel76(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(WIDTH - 100, -BIG_BLOCKING_SIZE), getVec2f(100, BIG_BLOCKING_SIZE + 20), NONE);
...
void World_generateLevel80(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(WIDTH - 20, 190), getVec2f(BIG_BLOCKING_SIZE, 80), NONE);
...
void World_generateLevel82(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(0, -BIG_BLOCKING_SIZE), getVec2f(20, BIG_BLOCKING_SIZE + 100), NONE);
...
void World_generateLevel83(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(0, 200), getVec2f(150, 70), NONE);
...
void World_generateLevel91(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(0, -BIG_BLOCKING_SIZE), getVec2f(WIDTH, BIG_BLOCKING_SIZE + 20), NONE);
...
void World_generateLevel92(World *world_p){
	...
	World_addObstacle(world_p, getVec2f(WIDTH - 130, -BIG_BLOCKING_SIZE), getVec2f(BIG_BLOCKING_SIZE, BIG_BLOCKING_SIZE), NONE);
...
void World_generateLevel93(World *world_p){

	World_restore(world_p);

	World_initPlayer(world_p, getVec2f(70, 70), NONE);

	World_addPoint(world_p, getVec2f(240, 160), ALL_FROM_TOP);
	...
	World_addScaleField(world_p, getVec2f(WIDTH - 90, 30), getVec2f(70, 60), ALL);

	//World_addScaleField(world_p, getVec2f(WIDTH - 70, 120), getVec2f(50, 90), NONE);

	World_addScaleField(world_p, getVec2f(0, 120), getVec2f(100, 90), NONE);

	World_addScaleField(world_p, getVec2f(WIDTH - 120, 120), getVec2f(100, 90), NONE);
}
